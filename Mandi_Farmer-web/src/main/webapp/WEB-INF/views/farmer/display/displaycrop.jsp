...
<link href="<%=request.getContextPath()%>/resources/css/styles.css"
	rel="stylesheet" />
<link href="<%=request.getContextPath()%>/resources/css/farmerCSS/mainfarmer/table.css"
	rel="stylesheet" />
				...
				<div class="collapse navbar-collapse" id="navbarResponsive">
					<ul class="navbar-nav text-uppercase ml-auto">
						<li class="nav-item"><a class="nav-link js-scroll-trigger"
							href="<%=request.getContextPath()%>/addcrop">Add Crop</a></li>
						<li class="nav-item"><a class="nav-link js-scroll-trigger"
							href="<%=request.getContextPath()%>/viewcrop">View All Crop</a></li>
						<li class="nav-item"><a class="nav-link js-scroll-trigger"
							href="#">Status</a></li>
						<li class="nav-item"><a class="nav-link js-scroll-trigger"
			...
			<tbody>
				<c:forEach var="crop" items="${crop}">
					<tr>
						...
						<td><a
							href="<%=request.getContextPath()%>/editcropbyid/${crop.id}">
								<i class="fas fa-user-edit ml-2"></i><font color="blue">
									Edit</font>
						</a>
							<hr /> <a
							href="<%=request.getContextPath()%>/deletecrop/${crop.id}"> <i
								class="fas fa-user-times ml-2 "></i><font color="blue">
									Delete</font></a></td>
					</tr>
