...
<body>
	...
	<div class="login-form">
		<form action="<%=request.getContextPath()%>/savecrop" method="post"
			...
			<div class="form-group">
				<label>Crop Name:</label> <input type="text" class="form-control"
					name="cropName" placeholder="Enter Your Crop Name"
					required="required">
			</div>
			<div class="form-group">
				<label>MSP Rate ( Rs :)</label> <select
					class="form-control colorPicker" name="msp">
					<option selected value="base">Please Select Crop for Msp</option>
				...
				</select> <input type="number" class="colorDisplay form-control"
					value="Autofill here" required="required" disabled="disabled">
			</div>
			<div class="form-group">
				<label>Quantity (In Quintal)</label> <input type="number"
					class="form-control" name="quantity"
					placeholder="Enter Quantity of Crop" required="required">
			</div>
			<div class="form-group">
