...
<body id="page-top">
	...
	<header id="header" class="header-transparent">
		...
		<header class="masthead">
			<div class="container">
				...
				<form class="login-box"
					action="<%=request.getContextPath()%>/validatetrader" method="post">
					<br> <br> <br> <br> <br>
					<h2>Login</h2>
							...
							<div class="col-md-8 offset-md-2">
								<div class="card">
									<div class="card-body">
										...
										<hr>
										<form action="<%=request.getContextPath()%>/mainTrader"
											method="post">
											<div class="form-group">
												<label for="exampleInputEmail">Name</label> <input
													type="text" class="form-control" name="traderName"
													id="userName" aria-describedby="emailHelp"
													placeholder="Enter Name" required>
											</div>
											<div class="form-group">
												<label for="exampleInputEmail1">Aadhaar Id</label> <input
													type="text" name="aadhaarId" class="form-control"
											...
											<div class="form-group">
												<label for="exampleInputEmail1">Mobile No.</label> <input
													...
													placeholder="Enter Mobile No." size="10" required>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<textarea id="useraddress" name="traderAddress"
											...
											<div class="btn-group  col-md-3 ">
												...
												<hr>
												<a
													href="<%=request.getContextPath()%>/resources/jsp/trader/login_trader.jsp"
		...
		<script
			src="<%=request.getContextPath()%>/resources/js/trader/js_trader.js"></script>
		<!-- Bootstrap core JS-->
		<script
